...
const Navbar = () => {
  ...
  return (
    <div className="z-10 flex fixed items-start  top-0 w-full justify-between">
      {/* logo */}
      <div className="p-3 ">
        <svg
      ...
      <div
        ...
        className="bg-black h-14 relative w-78  "
      >
        <div
          ref={navHoverRef}
          className="bg-[#D3FD50] transition-all absolute top-0 h-0 w-full"
        ></div>
        <div className="h-full  flex flex-col gap-1 items-end  justify-center px-12 cursor-pointer w-full ">
